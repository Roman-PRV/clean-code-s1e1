...
const taskInput=document.querySelector(".task__text_new");//Add a new task.
const addButton=document.querySelector(".btn_type_add");//first button
const incompleteTaskHolder=document.querySelector(".section__list_type_incompleted");
const completedTasksHolder=document.querySelector(".section__list_type_completed");
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="btn btn_type_edit";

    deleteButton.className="btn btn_type_delete";
